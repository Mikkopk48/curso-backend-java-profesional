# Unidad 21 — Laboratorio y práctica deliberada
...
## Laboratorio guiado — Agregaciones por cliente y moneda
...
2. Crea una rama <code>practice/u21</code>.
...
## U21-E01 — explicación: clave y valor

- **Objetivo:** aplicar clave y valor y justificar su relación con orden y comparadores.
- **Concepto evaluado:** clave y valor.
- **Dificultad:** 1/5.
- **Tipo:** explicación.
...
FintechLab incorpora la etapa **Agregaciones por cliente y moneda**. El caso feliz funciona, pero el equipo necesita evidencia de que el diseño conserva su significado ante una entrada límite, una repetición o un fallo de dependencia.
...
1. **Pista 1:** escribe primero la garantía observable de clave y valor.
2. **Pista 2:** localiza la frontera donde orden y comparadores cambia el resultado.
...
## U21-E02 — implementación: TreeMap

- **Objetivo:** aplicar TreeMap y justificar su relación con complejidad temporal aproximada.
- **Concepto evaluado:** TreeMap.
- **Dificultad:** 2/5.
- **Tipo:** implementación.
...
1. **Pista 1:** escribe primero la garantía observable de TreeMap.
2. **Pista 2:** localiza la frontera donde complejidad temporal aproximada cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U21-E03 — debugging: colisiones

- **Objetivo:** aplicar colisiones y justificar su relación con entrySet.
- **Concepto evaluado:** colisiones.
- **Dificultad:** 3/5.
- **Tipo:** debugging.
...
1. **Pista 1:** escribe primero la garantía observable de colisiones.
2. **Pista 2:** localiza la frontera donde entrySet cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U21-E04 — revisión: complejidad temporal aproximada

- **Objetivo:** aplicar complejidad temporal aproximada y justificar su relación con resolución de claves duplicadas.
- **Concepto evaluado:** complejidad temporal aproximada.
- **Dificultad:** 3/5.
- **Tipo:** revisión.
...
1. **Pista 1:** escribe primero la garantía observable de complejidad temporal aproximada.
2. **Pista 2:** localiza la frontera donde resolución de claves duplicadas cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U21-E05 — diseño: computeIfAbsent, merge y getOrDefault

- **Objetivo:** aplicar computeIfAbsent, merge y getOrDefault y justificar su relación con rendimiento y legibilidad.
- **Concepto evaluado:** computeIfAbsent, merge y getOrDefault.
- **Dificultad:** 4/5.
- **Tipo:** diseño.
...
1. **Pista 1:** escribe primero la garantía observable de computeIfAbsent, merge y getOrDefault.
2. **Pista 2:** localiza la frontera donde rendimiento y legibilidad cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U21-E06 — testing: mapas inmutables

- **Objetivo:** aplicar mapas inmutables y justificar su relación con LinkedHashMap.
- **Concepto evaluado:** mapas inmutables.
- **Dificultad:** 4/5.
- **Tipo:** testing.
...
1. **Pista 1:** escribe primero la garantía observable de mapas inmutables.
2. **Pista 2:** localiza la frontera donde LinkedHashMap cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U21-E07 — integración: Collectors.toMap

- **Objetivo:** aplicar Collectors.toMap y justificar su relación con buckets.
- **Concepto evaluado:** Collectors.toMap.
- **Dificultad:** 5/5.
- **Tipo:** integración.
...
1. **Pista 1:** escribe primero la garantía observable de Collectors.toMap.
2. **Pista 2:** localiza la frontera donde buckets cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U21-E08 — desafío opcional: partitioningBy

- **Objetivo:** aplicar partitioningBy y justificar su relación con computeIfAbsent, merge y getOrDefault.
- **Concepto evaluado:** partitioningBy.
- **Dificultad:** 5/5.
...
1. **Pista 1:** escribe primero la garantía observable de partitioningBy.
2. **Pista 2:** localiza la frontera donde computeIfAbsent, merge y getOrDefault cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.
