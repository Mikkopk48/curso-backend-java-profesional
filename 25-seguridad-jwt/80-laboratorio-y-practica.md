# Unidad 25 — Laboratorio y práctica deliberada
...
## Laboratorio guiado — Autenticación y autorización
...
2. Crea una rama <code>practice/u25</code>.
...
## U25-E01 — explicación: threat modeling básico

- **Objetivo:** aplicar threat modeling básico y justificar su relación con roles y permisos.
- **Concepto evaluado:** threat modeling básico.
- **Dificultad:** 1/5.
- **Tipo:** explicación.
...
FintechLab incorpora la etapa **Autenticación y autorización**. El caso feliz funciona, pero el equipo necesita evidencia de que el diseño conserva su significado ante una entrada límite, una repetición o un fallo de dependencia.
...
1. **Pista 1:** escribe primero la garantía observable de threat modeling básico.
2. **Pista 2:** localiza la frontera donde roles y permisos cambia el resultado.
...
## U25-E02 — implementación: identidad

- **Objetivo:** aplicar identidad y justificar su relación con contexto de seguridad.
- **Concepto evaluado:** identidad.
- **Dificultad:** 2/5.
- **Tipo:** implementación.
...
1. **Pista 1:** escribe primero la garantía observable de identidad.
2. **Pista 2:** localiza la frontera donde contexto de seguridad cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U25-E03 — debugging: Spring Security

- **Objetivo:** aplicar Spring Security y justificar su relación con BCrypt o Argon2.
- **Concepto evaluado:** Spring Security.
- **Dificultad:** 3/5.
- **Tipo:** debugging.
...
1. **Pista 1:** escribe primero la garantía observable de Spring Security.
2. **Pista 2:** localiza la frontera donde BCrypt o Argon2 cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U25-E04 — revisión: contexto de seguridad

- **Objetivo:** aplicar contexto de seguridad y justificar su relación con firma simétrica y asimétrica.
- **Concepto evaluado:** contexto de seguridad.
- **Dificultad:** 3/5.
- **Tipo:** revisión.
...
1. **Pista 1:** escribe primero la garantía observable de contexto de seguridad.
2. **Pista 2:** localiza la frontera donde firma simétrica y asimétrica cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U25-E05 — diseño: hash de contraseñas

- **Objetivo:** aplicar hash de contraseñas y justificar su relación con rotación.
- **Concepto evaluado:** hash de contraseñas.
- **Dificultad:** 4/5.
- **Tipo:** diseño.
...
1. **Pista 1:** escribe primero la garantía observable de hash de contraseñas.
2. **Pista 2:** localiza la frontera donde rotación cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U25-E06 — testing: por qué las contraseñas no se cifran reversiblemente

- **Objetivo:** aplicar por qué las contraseñas no se cifran reversiblemente y justificar su relación con cookies seguras frente a almacenamiento del navegador.
- **Concepto evaluado:** por qué las contraseñas no se cifran reversiblemente.
- **Dificultad:** 4/5.
- **Tipo:** testing.
...
1. **Pista 1:** escribe primero la garantía observable de por qué las contraseñas no se cifran reversiblemente.
2. **Pista 2:** localiza la frontera donde cookies seguras frente a almacenamiento del navegador cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U25-E07 — integración: claims registrados y personalizados

- **Objetivo:** aplicar claims registrados y personalizados y justificar su relación con secretos y rotación de claves.
- **Concepto evaluado:** claims registrados y personalizados.
- **Dificultad:** 5/5.
- **Tipo:** integración.
...
1. **Pista 1:** escribe primero la garantía observable de claims registrados y personalizados.
2. **Pista 2:** localiza la frontera donde secretos y rotación de claves cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U25-E08 — desafío opcional: validación de issuer, audience, expiración y not-before

- **Objetivo:** aplicar validación de issuer, audience, expiración y not-before y justificar su relación con OAuth 2.0 y OpenID Connect como mapa conceptual, sin confundirlos con JWT.
- **Concepto evaluado:** validación de issuer, audience, expiración y not-before.
- **Dificultad:** 5/5.
...
1. **Pista 1:** escribe primero la garantía observable de validación de issuer, audience, expiración y not-before.
2. **Pista 2:** localiza la frontera donde OAuth 2.0 y OpenID Connect como mapa conceptual, sin confundirlos con JWT cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.
