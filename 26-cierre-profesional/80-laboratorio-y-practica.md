# Unidad 26 — Laboratorio y práctica deliberada
...
## Laboratorio guiado — Entrega y defensa técnica
...
2. Crea una rama <code>practice/u26</code>.
...
## U26-E01 — explicación: recorrido de una petición desde el cliente hasta la base de datos

- **Objetivo:** aplicar recorrido de una petición desde el cliente hasta la base de datos y justificar su relación con checklist de calidad.
- **Concepto evaluado:** recorrido de una petición desde el cliente hasta la base de datos.
- **Dificultad:** 1/5.
- **Tipo:** explicación.
...
FintechLab incorpora la etapa **Entrega y defensa técnica**. El caso feliz funciona, pero el equipo necesita evidencia de que el diseño conserva su significado ante una entrada límite, una repetición o un fallo de dependencia.
...
1. **Pista 1:** escribe primero la garantía observable de recorrido de una petición desde el cliente hasta la base de datos.
2. **Pista 2:** localiza la frontera donde checklist de calidad cambia el resultado.
...
## U26-E02 — implementación: matriz de fallos posibles

- **Objetivo:** aplicar matriz de fallos posibles y justificar su relación con guía de code review.
- **Concepto evaluado:** matriz de fallos posibles.
- **Dificultad:** 2/5.
- **Tipo:** implementación.
...
1. **Pista 1:** escribe primero la garantía observable de matriz de fallos posibles.
2. **Pista 2:** localiza la frontera donde guía de code review cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U26-E03 — debugging: checklist de base de datos

- **Objetivo:** aplicar checklist de base de datos y justificar su relación con revisión de deuda técnica.
- **Concepto evaluado:** checklist de base de datos.
- **Dificultad:** 3/5.
- **Tipo:** debugging.
...
1. **Pista 1:** escribe primero la garantía observable de checklist de base de datos.
2. **Pista 2:** localiza la frontera donde revisión de deuda técnica cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U26-E04 — revisión: guía de code review

- **Objetivo:** aplicar guía de code review y justificar su relación con contrato OpenAPI.
- **Concepto evaluado:** guía de code review.
- **Dificultad:** 3/5.
- **Tipo:** revisión.
...
1. **Pista 1:** escribe primero la garantía observable de guía de code review.
2. **Pista 2:** localiza la frontera donde contrato OpenAPI cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U26-E05 — diseño: preparación de una demostración

- **Objetivo:** aplicar preparación de una demostración y justificar su relación con logs útiles sin datos sensibles.
- **Concepto evaluado:** preparación de una demostración.
- **Dificultad:** 4/5.
- **Tipo:** diseño.
...
1. **Pista 1:** escribe primero la garantía observable de preparación de una demostración.
2. **Pista 2:** localiza la frontera donde logs útiles sin datos sensibles cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U26-E06 — testing: plan de mejora posterior

- **Objetivo:** aplicar plan de mejora posterior y justificar su relación con recorrido de una llamada entre microservicios.
- **Concepto evaluado:** plan de mejora posterior.
- **Dificultad:** 4/5.
- **Tipo:** testing.
...
1. **Pista 1:** escribe primero la garantía observable de plan de mejora posterior.
2. **Pista 2:** localiza la frontera donde recorrido de una llamada entre microservicios cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U26-E07 — integración: decisiones

- **Objetivo:** aplicar decisiones y justificar su relación con checklist de base de datos.
- **Concepto evaluado:** decisiones.
- **Dificultad:** 5/5.
- **Tipo:** integración.
...
1. **Pista 1:** escribe primero la garantía observable de decisiones.
2. **Pista 2:** localiza la frontera donde checklist de base de datos cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U26-E08 — desafío opcional: tests

- **Objetivo:** aplicar tests y justificar su relación con ADR finales.
- **Concepto evaluado:** tests.
- **Dificultad:** 5/5.
...
1. **Pista 1:** escribe primero la garantía observable de tests.
2. **Pista 2:** localiza la frontera donde ADR finales cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.
