# Unidad 19 — Laboratorio y práctica deliberada
...
## Laboratorio guiado — Pipeline verificable
...
2. Crea una rama <code>practice/u19</code>.
...
## U19-E01 — explicación: continuous delivery

- **Objetivo:** aplicar continuous delivery y justificar su relación con evento, workflow, job, step, runner y action.
- **Concepto evaluado:** continuous delivery.
- **Dificultad:** 1/5.
- **Tipo:** explicación.
...
FintechLab incorpora la etapa **Pipeline verificable**. El caso feliz funciona, pero el equipo necesita evidencia de que el diseño conserva su significado ante una entrada límite, una repetición o un fallo de dependencia.
...
1. **Pista 1:** escribe primero la garantía observable de continuous delivery.
2. **Pista 2:** localiza la frontera donde evento, workflow, job, step, runner y action cambia el resultado.
...
## U19-E02 — implementación: pipeline

- **Objetivo:** aplicar pipeline y justificar su relación con caché de Maven.
- **Concepto evaluado:** pipeline.
- **Dificultad:** 2/5.
- **Tipo:** implementación.
...
1. **Pista 1:** escribe primero la garantía observable de pipeline.
2. **Pista 2:** localiza la frontera donde caché de Maven cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U19-E03 — debugging: triggers

- **Objetivo:** aplicar triggers y justificar su relación con cobertura.
- **Concepto evaluado:** triggers.
- **Dificultad:** 3/5.
- **Tipo:** debugging.
...
1. **Pista 1:** escribe primero la garantía observable de triggers.
2. **Pista 2:** localiza la frontera donde cobertura cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U19-E04 — revisión: caché de Maven

- **Objetivo:** aplicar caché de Maven y justificar su relación con tags reproducibles.
- **Concepto evaluado:** caché de Maven.
- **Dificultad:** 3/5.
- **Tipo:** revisión.
...
1. **Pista 1:** escribe primero la garantía observable de caché de Maven.
2. **Pista 2:** localiza la frontera donde tags reproducibles cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U19-E05 — diseño: tests de integración

- **Objetivo:** aplicar tests de integración y justificar su relación con matrices.
- **Concepto evaluado:** tests de integración.
- **Dificultad:** 4/5.
- **Tipo:** diseño.
...
1. **Pista 1:** escribe primero la garantía observable de tests de integración.
2. **Pista 2:** localiza la frontera donde matrices cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U19-E06 — testing: quality gates

- **Objetivo:** aplicar quality gates y justificar su relación con escaneo de dependencias.
- **Concepto evaluado:** quality gates.
- **Dificultad:** 4/5.
- **Tipo:** testing.
...
1. **Pista 1:** escribe primero la garantía observable de quality gates.
2. **Pista 2:** localiza la frontera donde escaneo de dependencias cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U19-E07 — integración: creación de imagen de contenedor

- **Objetivo:** aplicar creación de imagen de contenedor y justificar su relación con integración continua.
- **Concepto evaluado:** creación de imagen de contenedor.
- **Dificultad:** 5/5.
- **Tipo:** integración.
...
1. **Pista 1:** escribe primero la garantía observable de creación de imagen de contenedor.
2. **Pista 2:** localiza la frontera donde integración continua cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U19-E08 — desafío opcional: permisos mínimos

- **Objetivo:** aplicar permisos mínimos y justificar su relación con evento, workflow, job, step, runner y action.
- **Concepto evaluado:** permisos mínimos.
- **Dificultad:** 5/5.
...
1. **Pista 1:** escribe primero la garantía observable de permisos mínimos.
2. **Pista 2:** localiza la frontera donde evento, workflow, job, step, runner y action cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.
