# Unidad 16 — Laboratorio y práctica deliberada
...
## Laboratorio guiado — Cliente de notificaciones
...
2. Crea una rama <code>practice/u16</code>.
...
## U16-E01 — explicación: cliente imperativo frente a cliente declarativo

- **Objetivo:** aplicar cliente imperativo frente a cliente declarativo y justificar su relación con DTO de contrato.
- **Concepto evaluado:** cliente imperativo frente a cliente declarativo.
- **Dificultad:** 1/5.
- **Tipo:** explicación.
...
FintechLab incorpora la etapa **Cliente de notificaciones**. El caso feliz funciona, pero el equipo necesita evidencia de que el diseño conserva su significado ante una entrada límite, una repetición o un fallo de dependencia.
...
1. **Pista 1:** escribe primero la garantía observable de cliente imperativo frente a cliente declarativo.
2. **Pista 2:** localiza la frontera donde DTO de contrato cambia el resultado.
...
## U16-E02 — implementación: serialización de parámetros y cuerpos

- **Objetivo:** aplicar serialización de parámetros y cuerpos y justificar su relación con manejo de errores.
- **Concepto evaluado:** serialización de parámetros y cuerpos.
- **Dificultad:** 2/5.
- **Tipo:** implementación.
...
1. **Pista 1:** escribe primero la garantía observable de serialización de parámetros y cuerpos.
2. **Pista 2:** localiza la frontera donde manejo de errores cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U16-E03 — debugging: propagación segura de identidad

- **Objetivo:** aplicar propagación segura de identidad y justificar su relación con peligro de reintentar operaciones no idempotentes.
- **Concepto evaluado:** propagación segura de identidad.
- **Dificultad:** 3/5.
- **Tipo:** debugging.
...
1. **Pista 1:** escribe primero la garantía observable de propagación segura de identidad.
2. **Pista 2:** localiza la frontera donde peligro de reintentar operaciones no idempotentes cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U16-E04 — revisión: manejo de errores

- **Objetivo:** aplicar manejo de errores y justificar su relación con pruebas con WireMock.
- **Concepto evaluado:** manejo de errores.
- **Dificultad:** 3/5.
- **Tipo:** revisión.
...
1. **Pista 1:** escribe primero la garantía observable de manejo de errores.
2. **Pista 2:** localiza la frontera donde pruebas con WireMock cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U16-E05 — diseño: balanceo

- **Objetivo:** aplicar balanceo y justificar su relación con Spring Cloud OpenFeign.
- **Concepto evaluado:** balanceo.
- **Dificultad:** 4/5.
- **Tipo:** diseño.
...
1. **Pista 1:** escribe primero la garantía observable de balanceo.
2. **Pista 2:** localiza la frontera donde Spring Cloud OpenFeign cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U16-E06 — testing: integración con circuit breaker

- **Objetivo:** aplicar integración con circuit breaker y justificar su relación con propagación segura de identidad.
- **Concepto evaluado:** integración con circuit breaker.
- **Dificultad:** 4/5.
- **Tipo:** testing.
...
1. **Pista 1:** escribe primero la garantía observable de integración con circuit breaker.
2. **Pista 2:** localiza la frontera donde propagación segura de identidad cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U16-E07 — integración: evolución de contratos

- **Objetivo:** aplicar evolución de contratos y justificar su relación con logging sin filtrar secretos.
- **Concepto evaluado:** evolución de contratos.
- **Dificultad:** 5/5.
- **Tipo:** integración.
...
1. **Pista 1:** escribe primero la garantía observable de evolución de contratos.
2. **Pista 2:** localiza la frontera donde logging sin filtrar secretos cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U16-E08 — desafío opcional: acoplamiento entre servicios

- **Objetivo:** aplicar acoplamiento entre servicios y justificar su relación con fallbacks y sus riesgos.
- **Concepto evaluado:** acoplamiento entre servicios.
- **Dificultad:** 5/5.
...
1. **Pista 1:** escribe primero la garantía observable de acoplamiento entre servicios.
2. **Pista 2:** localiza la frontera donde fallbacks y sus riesgos cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.
