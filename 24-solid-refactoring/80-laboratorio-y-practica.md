# Unidad 24 — Laboratorio y práctica deliberada
...
## Laboratorio guiado — Mejora segura del diseño
...
2. Crea una rama <code>practice/u24</code>.
...
## U24-E01 — explicación: acoplamiento

- **Objetivo:** aplicar acoplamiento y justificar su relación con Open/Closed Principle.
- **Concepto evaluado:** acoplamiento.
- **Dificultad:** 1/5.
- **Tipo:** explicación.
...
FintechLab incorpora la etapa **Mejora segura del diseño**. El caso feliz funciona, pero el equipo necesita evidencia de que el diseño conserva su significado ante una entrada límite, una repetición o un fallo de dependencia.
...
1. **Pista 1:** escribe primero la garantía observable de acoplamiento.
2. **Pista 2:** localiza la frontera donde Open/Closed Principle cambia el resultado.
...
## U24-E02 — implementación: Single Responsibility Principle

- **Objetivo:** aplicar Single Responsibility Principle y justificar su relación con composición frente a herencia.
- **Concepto evaluado:** Single Responsibility Principle.
- **Dificultad:** 2/5.
- **Tipo:** implementación.
...
1. **Pista 1:** escribe primero la garantía observable de Single Responsibility Principle.
2. **Pista 2:** localiza la frontera donde composición frente a herencia cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U24-E03 — debugging: Interface Segregation Principle

- **Objetivo:** aplicar Interface Segregation Principle y justificar su relación con aplicación a controller, service, repository y clientes externos.
- **Concepto evaluado:** Interface Segregation Principle.
- **Dificultad:** 3/5.
- **Tipo:** debugging.
...
1. **Pista 1:** escribe primero la garantía observable de Interface Segregation Principle.
2. **Pista 2:** localiza la frontera donde aplicación a controller, service, repository y clientes externos cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U24-E04 — revisión: composición frente a herencia

- **Objetivo:** aplicar composición frente a herencia y justificar su relación con uso de IA para sugerir refactorizaciones.
- **Concepto evaluado:** composición frente a herencia.
- **Dificultad:** 3/5.
- **Tipo:** revisión.
...
1. **Pista 1:** escribe primero la garantía observable de composición frente a herencia.
2. **Pista 2:** localiza la frontera donde uso de IA para sugerir refactorizaciones cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U24-E05 — diseño: límites de módulos

- **Objetivo:** aplicar límites de módulos y justificar su relación con consecuencias.
- **Concepto evaluado:** límites de módulos.
- **Dificultad:** 4/5.
- **Tipo:** diseño.
...
1. **Pista 1:** escribe primero la garantía observable de límites de módulos.
2. **Pista 2:** localiza la frontera donde consecuencias cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U24-E06 — testing: relación con patrones de diseño

- **Objetivo:** aplicar relación con patrones de diseño y justificar su relación con acoplamiento.
- **Concepto evaluado:** relación con patrones de diseño.
- **Dificultad:** 4/5.
- **Tipo:** testing.
...
1. **Pista 1:** escribe primero la garantía observable de relación con patrones de diseño.
2. **Pista 2:** localiza la frontera donde acoplamiento cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U24-E07 — integración: cuándo una violación aparente puede ser un compromiso aceptable

- **Objetivo:** aplicar cuándo una violación aparente puede ser un compromiso aceptable y justificar su relación con Liskov Substitution Principle.
- **Concepto evaluado:** cuándo una violación aparente puede ser un compromiso aceptable.
- **Dificultad:** 5/5.
- **Tipo:** integración.
...
1. **Pista 1:** escribe primero la garantía observable de cuándo una violación aparente puede ser un compromiso aceptable.
2. **Pista 2:** localiza la frontera donde Liskov Substitution Principle cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U24-E08 — desafío opcional: definición sencilla

- **Objetivo:** aplicar definición sencilla y justificar su relación con diseño orientado a comportamiento.
- **Concepto evaluado:** definición sencilla.
- **Dificultad:** 5/5.
...
1. **Pista 1:** escribe primero la garantía observable de definición sencilla.
2. **Pista 2:** localiza la frontera donde diseño orientado a comportamiento cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.
