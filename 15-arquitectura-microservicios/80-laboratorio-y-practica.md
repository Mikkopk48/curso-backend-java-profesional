# Unidad 15 — Laboratorio y práctica deliberada
...
## Laboratorio guiado — Decisión de separación
...
2. Crea una rama <code>practice/u15</code>.
...
## U15-E01 — explicación: ventajas, costos y señales reales para elegir

- **Objetivo:** aplicar ventajas, costos y señales reales para elegir y justificar su relación con cohesión y acoplamiento.
- **Concepto evaluado:** ventajas, costos y señales reales para elegir.
- **Dificultad:** 1/5.
- **Tipo:** explicación.
...
FintechLab incorpora la etapa **Decisión de separación**. El caso feliz funciona, pero el equipo necesita evidencia de que el diseño conserva su significado ante una entrada límite, una repetición o un fallo de dependencia.
...
1. **Pista 1:** escribe primero la garantía observable de ventajas, costos y señales reales para elegir.
2. **Pista 2:** localiza la frontera donde cohesión y acoplamiento cambia el resultado.
...
## U15-E02 — implementación: bounded context como introducción

- **Objetivo:** aplicar bounded context como introducción y justificar su relación con latencia.
- **Concepto evaluado:** bounded context como introducción.
- **Dificultad:** 2/5.
- **Tipo:** implementación.
...
1. **Pista 1:** escribe primero la garantía observable de bounded context como introducción.
2. **Pista 2:** localiza la frontera donde latencia cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U15-E03 — debugging: propiedad de datos

- **Objetivo:** aplicar propiedad de datos y justificar su relación con API Gateway.
- **Concepto evaluado:** propiedad de datos.
- **Dificultad:** 3/5.
- **Tipo:** debugging.
...
1. **Pista 1:** escribe primero la garantía observable de propiedad de datos.
2. **Pista 2:** localiza la frontera donde API Gateway cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U15-E04 — revisión: latencia

- **Objetivo:** aplicar latencia y justificar su relación con observabilidad.
- **Concepto evaluado:** latencia.
- **Dificultad:** 3/5.
- **Tipo:** revisión.
...
1. **Pista 1:** escribe primero la garantía observable de latencia.
2. **Pista 2:** localiza la frontera donde observabilidad cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U15-E05 — diseño: saga como introducción

- **Objetivo:** aplicar saga como introducción y justificar su relación con seguridad entre servicios.
- **Concepto evaluado:** saga como introducción.
- **Dificultad:** 4/5.
- **Tipo:** diseño.
...
1. **Pista 1:** escribe primero la garantía observable de saga como introducción.
2. **Pista 2:** localiza la frontera donde seguridad entre servicios cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U15-E06 — testing: service discovery

- **Objetivo:** aplicar service discovery y justificar su relación con ventajas, costos y señales reales para elegir.
- **Concepto evaluado:** service discovery.
- **Dificultad:** 4/5.
- **Tipo:** testing.
...
1. **Pista 1:** escribe primero la garantía observable de service discovery.
2. **Pista 2:** localiza la frontera donde ventajas, costos y señales reales para elegir cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U15-E07 — integración: timeout, retry, circuit breaker y bulkhead

- **Objetivo:** aplicar timeout, retry, circuit breaker y bulkhead y justificar su relación con base de datos por servicio.
- **Concepto evaluado:** timeout, retry, circuit breaker y bulkhead.
- **Dificultad:** 5/5.
- **Tipo:** integración.
...
1. **Pista 1:** escribe primero la garantía observable de timeout, retry, circuit breaker y bulkhead.
2. **Pista 2:** localiza la frontera donde base de datos por servicio cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U15-E08 — desafío opcional: despliegue independiente

- **Objetivo:** aplicar despliegue independiente y justificar su relación con consistencia fuerte y eventual.
- **Concepto evaluado:** despliegue independiente.
- **Dificultad:** 5/5.
...
1. **Pista 1:** escribe primero la garantía observable de despliegue independiente.
2. **Pista 2:** localiza la frontera donde consistencia fuerte y eventual cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.
