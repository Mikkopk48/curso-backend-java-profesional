# Unidad 17 — Laboratorio y práctica deliberada
...
## Laboratorio guiado — Instancias dinámicas
...
2. Crea una rama <code>practice/u17</code>.
...
## U17-E01 — explicación: service registry

- **Objetivo:** aplicar service registry y justificar su relación con identidad de aplicación e instancia.
- **Concepto evaluado:** service registry.
- **Dificultad:** 1/5.
- **Tipo:** explicación.
...
FintechLab incorpora la etapa **Instancias dinámicas**. El caso feliz funciona, pero el equipo necesita evidencia de que el diseño conserva su significado ante una entrada límite, una repetición o un fallo de dependencia.
...
1. **Pista 1:** escribe primero la garantía observable de service registry.
2. **Pista 2:** localiza la frontera donde identidad de aplicación e instancia cambia el resultado.
...
## U17-E02 — implementación: Eureka Client

- **Objetivo:** aplicar Eureka Client y justificar su relación con múltiples instancias.
- **Concepto evaluado:** Eureka Client.
- **Dificultad:** 2/5.
- **Tipo:** implementación.
...
1. **Pista 1:** escribe primero la garantía observable de Eureka Client.
2. **Pista 2:** localiza la frontera donde múltiples instancias cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U17-E03 — debugging: leases

- **Objetivo:** aplicar leases y justificar su relación con self-preservation explicado con cuidado.
- **Concepto evaluado:** leases.
- **Dificultad:** 3/5.
- **Tipo:** debugging.
...
1. **Pista 1:** escribe primero la garantía observable de leases.
2. **Pista 2:** localiza la frontera donde self-preservation explicado con cuidado cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U17-E04 — revisión: múltiples instancias

- **Objetivo:** aplicar múltiples instancias y justificar su relación con direcciones dinámicas.
- **Concepto evaluado:** múltiples instancias.
- **Dificultad:** 3/5.
- **Tipo:** revisión.
...
1. **Pista 1:** escribe primero la garantía observable de múltiples instancias.
2. **Pista 2:** localiza la frontera donde direcciones dinámicas cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U17-E05 — diseño: salud de instancias

- **Objetivo:** aplicar salud de instancias y justificar su relación con identidad de aplicación e instancia.
- **Concepto evaluado:** salud de instancias.
- **Dificultad:** 4/5.
- **Tipo:** diseño.
...
1. **Pista 1:** escribe primero la garantía observable de salud de instancias.
2. **Pista 2:** localiza la frontera donde identidad de aplicación e instancia cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U17-E06 — testing: límites y riesgos

- **Objetivo:** aplicar límites y riesgos y justificar su relación con múltiples instancias.
- **Concepto evaluado:** límites y riesgos.
- **Dificultad:** 4/5.
- **Tipo:** testing.
...
1. **Pista 1:** escribe primero la garantía observable de límites y riesgos.
2. **Pista 2:** localiza la frontera donde múltiples instancias cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U17-E07 — integración: escenarios donde Eureka tiene sentido y donde no

- **Objetivo:** aplicar escenarios donde Eureka tiene sentido y donde no y justificar su relación con self-preservation explicado con cuidado.
- **Concepto evaluado:** escenarios donde Eureka tiene sentido y donde no.
- **Dificultad:** 5/5.
- **Tipo:** integración.
...
1. **Pista 1:** escribe primero la garantía observable de escenarios donde Eureka tiene sentido y donde no.
2. **Pista 2:** localiza la frontera donde self-preservation explicado con cuidado cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U17-E08 — desafío opcional: registro y descubrimiento

- **Objetivo:** aplicar registro y descubrimiento y justificar su relación con direcciones dinámicas.
- **Concepto evaluado:** registro y descubrimiento.
- **Dificultad:** 5/5.
...
1. **Pista 1:** escribe primero la garantía observable de registro y descubrimiento.
2. **Pista 2:** localiza la frontera donde direcciones dinámicas cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.
