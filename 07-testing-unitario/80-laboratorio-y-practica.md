# Unidad 7 — Laboratorio y práctica deliberada
...
## Laboratorio guiado — Servicios de dominio comprobables
...
2. Crea una rama <code>practice/u07</code>.
...
## U07-E01 — explicación: riesgo, comportamiento y especificación

- **Objetivo:** aplicar riesgo, comportamiento y especificación y justificar su relación con JUnit 5.
- **Concepto evaluado:** riesgo, comportamiento y especificación.
- **Dificultad:** 1/5.
- **Tipo:** explicación.
...
FintechLab incorpora la etapa **Servicios de dominio comprobables**. El caso feliz funciona, pero el equipo necesita evidencia de que el diseño conserva su significado ante una entrada límite, una repetición o un fallo de dependencia.
...
1. **Pista 1:** escribe primero la garantía observable de riesgo, comportamiento y especificación.
2. **Pista 2:** localiza la frontera donde JUnit 5 cambia el resultado.
...
## U07-E02 — implementación: estructura Arrange, Act, Assert

- **Objetivo:** aplicar estructura Arrange, Act, Assert y justificar su relación con Given, When, Then.
- **Concepto evaluado:** estructura Arrange, Act, Assert.
- **Dificultad:** 2/5.
- **Tipo:** implementación.
...
1. **Pista 1:** escribe primero la garantía observable de estructura Arrange, Act, Assert.
2. **Pista 2:** localiza la frontera donde Given, When, Then cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U07-E03 — debugging: assertions

- **Objetivo:** aplicar assertions y justificar su relación con excepciones y casos límite.
- **Concepto evaluado:** assertions.
- **Dificultad:** 3/5.
- **Tipo:** debugging.
...
1. **Pista 1:** escribe primero la garantía observable de assertions.
2. **Pista 2:** localiza la frontera donde excepciones y casos límite cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U07-E04 — revisión: Given, When, Then

- **Objetivo:** aplicar Given, When, Then y justificar su relación con por qué 100 % de cobertura no garantiza calidad.
- **Concepto evaluado:** Given, When, Then.
- **Dificultad:** 3/5.
- **Tipo:** revisión.
...
1. **Pista 1:** escribe primero la garantía observable de Given, When, Then.
2. **Pista 2:** localiza la frontera donde por qué 100 % de cobertura no garantiza calidad cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U07-E05 — diseño: stubbing y verification

- **Objetivo:** aplicar stubbing y verification y justificar su relación con riesgo, comportamiento y especificación.
- **Concepto evaluado:** stubbing y verification.
- **Dificultad:** 4/5.
- **Tipo:** diseño.
...
1. **Pista 1:** escribe primero la garantía observable de stubbing y verification.
2. **Pista 2:** localiza la frontera donde riesgo, comportamiento y especificación cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U07-E06 — testing: determinismo

- **Objetivo:** aplicar determinismo y justificar su relación con ciclo de vida de pruebas.
- **Concepto evaluado:** determinismo.
- **Dificultad:** 4/5.
- **Tipo:** testing.
...
1. **Pista 1:** escribe primero la garantía observable de determinismo.
2. **Pista 2:** localiza la frontera donde ciclo de vida de pruebas cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U07-E07 — integración: cobertura de líneas y ramas

- **Objetivo:** aplicar cobertura de líneas y ramas y justificar su relación con dobles de prueba: dummy, stub, fake, spy y mock.
- **Concepto evaluado:** cobertura de líneas y ramas.
- **Dificultad:** 5/5.
- **Tipo:** integración.
...
1. **Pista 1:** escribe primero la garantía observable de cobertura de líneas y ramas.
2. **Pista 2:** localiza la frontera donde dobles de prueba: dummy, stub, fake, spy y mock cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U07-E08 — desafío opcional: pruebas generadas con IA y revisión crítica

- **Objetivo:** aplicar pruebas generadas con IA y revisión crítica y justificar su relación con determinismo.
- **Concepto evaluado:** pruebas generadas con IA y revisión crítica.
- **Dificultad:** 5/5.
...
1. **Pista 1:** escribe primero la garantía observable de pruebas generadas con IA y revisión crítica.
2. **Pista 2:** localiza la frontera donde determinismo cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.
