# Unidad 22 — Laboratorio y práctica deliberada
...
## Laboratorio guiado — Contratos separados de JPA
...
2. Crea una rama <code>practice/u22</code>.
...
## U22-E01 — explicación: por qué no exponer entidades

- **Objetivo:** aplicar por qué no exponer entidades y justificar su relación con generación de código en compilación.
- **Concepto evaluado:** por qué no exponer entidades.
- **Dificultad:** 1/5.
- **Tipo:** explicación.
...
FintechLab incorpora la etapa **Contratos separados de JPA**. El caso feliz funciona, pero el equipo necesita evidencia de que el diseño conserva su significado ante una entrada límite, una repetición o un fallo de dependencia.
...
1. **Pista 1:** escribe primero la garantía observable de por qué no exponer entidades.
2. **Pista 2:** localiza la frontera donde generación de código en compilación cambia el resultado.
...
## U22-E02 — implementación: MapStruct

- **Objetivo:** aplicar MapStruct y justificar su relación con campos con nombres distintos.
- **Concepto evaluado:** MapStruct.
- **Dificultad:** 2/5.
- **Tipo:** implementación.
...
1. **Pista 1:** escribe primero la garantía observable de MapStruct.
2. **Pista 2:** localiza la frontera donde campos con nombres distintos cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U22-E03 — debugging: @Mapper

- **Objetivo:** aplicar @Mapper y justificar su relación con colecciones.
- **Concepto evaluado:** @Mapper.
- **Dificultad:** 3/5.
- **Tipo:** debugging.
...
1. **Pista 1:** escribe primero la garantía observable de @Mapper.
2. **Pista 2:** localiza la frontera donde colecciones cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U22-E04 — revisión: campos con nombres distintos

- **Objetivo:** aplicar campos con nombres distintos y justificar su relación con mappers reutilizables.
- **Concepto evaluado:** campos con nombres distintos.
- **Dificultad:** 3/5.
- **Tipo:** revisión.
...
1. **Pista 1:** escribe primero la garantía observable de campos con nombres distintos.
2. **Pista 2:** localiza la frontera donde mappers reutilizables cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U22-E05 — diseño: enums

- **Objetivo:** aplicar enums y justificar su relación con comparación con mapeadores basados en reflexión.
- **Concepto evaluado:** enums.
- **Dificultad:** 4/5.
- **Tipo:** diseño.
...
1. **Pista 1:** escribe primero la garantía observable de enums.
2. **Pista 2:** localiza la frontera donde comparación con mapeadores basados en reflexión cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U22-E06 — testing: valores nulos

- **Objetivo:** aplicar valores nulos y justificar su relación con ventajas y costos.
- **Concepto evaluado:** valores nulos.
- **Dificultad:** 4/5.
- **Tipo:** testing.
...
1. **Pista 1:** escribe primero la garantía observable de valores nulos.
2. **Pista 2:** localiza la frontera donde ventajas y costos cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U22-E07 — integración: @MappingTarget

- **Objetivo:** aplicar @MappingTarget y justificar su relación con componentModel de Spring.
- **Concepto evaluado:** @MappingTarget.
- **Dificultad:** 5/5.
- **Tipo:** integración.
...
1. **Pista 1:** escribe primero la garantía observable de @MappingTarget.
2. **Pista 2:** localiza la frontera donde componentModel de Spring cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U22-E08 — desafío opcional: relaciones JPA

- **Objetivo:** aplicar relaciones JPA y justificar su relación con enums.
- **Concepto evaluado:** relaciones JPA.
- **Dificultad:** 5/5.
...
1. **Pista 1:** escribe primero la garantía observable de relaciones JPA.
2. **Pista 2:** localiza la frontera donde enums cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.
