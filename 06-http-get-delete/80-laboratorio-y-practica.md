# Unidad 6 — Laboratorio y práctica deliberada
...
## Laboratorio guiado — Contrato de consulta y baja
...
2. Crea una rama <code>practice/u06</code>.
...
## U06-E01 — explicación: anatomía real de una petición y una respuesta

- **Objetivo:** aplicar anatomía real de una petición y una respuesta y justificar su relación con headers importantes.
- **Concepto evaluado:** anatomía real de una petición y una respuesta.
- **Dificultad:** 1/5.
- **Tipo:** explicación.
...
FintechLab incorpora la etapa **Contrato de consulta y baja**. El caso feliz funciona, pero el equipo necesita evidencia de que el diseño conserva su significado ante una entrada límite, una repetición o un fallo de dependencia.
...
1. **Pista 1:** escribe primero la garantía observable de anatomía real de una petición y una respuesta.
2. **Pista 2:** localiza la frontera donde headers importantes cambia el resultado.
...
## U06-E02 — implementación: path parameters y query parameters

- **Objetivo:** aplicar path parameters y query parameters y justificar su relación con semántica de DELETE.
- **Concepto evaluado:** path parameters y query parameters.
- **Dificultad:** 2/5.
- **Tipo:** implementación.
...
1. **Pista 1:** escribe primero la garantía observable de path parameters y query parameters.
2. **Pista 2:** localiza la frontera donde semántica de DELETE cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U06-E03 — debugging: JSON y tipos de medios

- **Objetivo:** aplicar JSON y tipos de medios y justificar su relación con qué debería responder DELETE.
- **Concepto evaluado:** JSON y tipos de medios.
- **Dificultad:** 3/5.
- **Tipo:** debugging.
...
1. **Pista 1:** escribe primero la garantía observable de JSON y tipos de medios.
2. **Pista 2:** localiza la frontera donde qué debería responder DELETE cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U06-E04 — revisión: semántica de DELETE

- **Objetivo:** aplicar semántica de DELETE y justificar su relación con pruebas de endpoints.
- **Concepto evaluado:** semántica de DELETE.
- **Dificultad:** 3/5.
- **Tipo:** revisión.
...
1. **Pista 1:** escribe primero la garantía observable de semántica de DELETE.
2. **Pista 2:** localiza la frontera donde pruebas de endpoints cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U06-E05 — diseño: filtros, ordenamiento y paginación

- **Objetivo:** aplicar filtros, ordenamiento y paginación y justificar su relación con recursos y diseño de URI.
- **Concepto evaluado:** filtros, ordenamiento y paginación.
- **Dificultad:** 4/5.
- **Tipo:** diseño.
...
1. **Pista 1:** escribe primero la garantía observable de filtros, ordenamiento y paginación.
2. **Pista 2:** localiza la frontera donde recursos y diseño de URI cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U06-E06 — testing: borrado lógico frente a borrado físico

- **Objetivo:** aplicar borrado lógico frente a borrado físico y justificar su relación con métodos seguros e idempotentes.
- **Concepto evaluado:** borrado lógico frente a borrado físico.
- **Dificultad:** 4/5.
- **Tipo:** testing.
...
1. **Pista 1:** escribe primero la garantía observable de borrado lógico frente a borrado físico.
2. **Pista 2:** localiza la frontera donde métodos seguros e idempotentes cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U06-E07 — integración: ResponseEntity

- **Objetivo:** aplicar ResponseEntity y justificar su relación con filtros, ordenamiento y paginación.
- **Concepto evaluado:** ResponseEntity.
- **Dificultad:** 5/5.
- **Tipo:** integración.
...
1. **Pista 1:** escribe primero la garantía observable de ResponseEntity.
2. **Pista 2:** localiza la frontera donde filtros, ordenamiento y paginación cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.

## U06-E08 — desafío opcional: papel de HTTP en una arquitectura cliente-servidor

- **Objetivo:** aplicar papel de HTTP en una arquitectura cliente-servidor y justificar su relación con implementación con Spring MVC.
- **Concepto evaluado:** papel de HTTP en una arquitectura cliente-servidor.
- **Dificultad:** 5/5.
...
1. **Pista 1:** escribe primero la garantía observable de papel de HTTP en una arquitectura cliente-servidor.
2. **Pista 2:** localiza la frontera donde implementación con Spring MVC cambia el resultado.
3. **Pista 3:** prepara una entrada mínima, ejecuta una sola acción y verifica estado más evidencia; no copies el ejemplo del capítulo.
